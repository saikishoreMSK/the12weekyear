...
/** Inline form to add a goal to a cycle. Week range defaults to the whole cycle. */
export function AddGoalForm({ cycleId, totalWeeks, onAdded }: Props) {
  ...
  async function submit(e: React.FormEvent) {
    ...
    setSaving(true);
    try {
      await cycleApi.addGoal(cycleId, {
